...
import { HvacCard, HvacTable, HvacCalendar } from '../ui/HvacNativeComponents';
import { Dropdown, InputText, ConfirmDialog, toast } from '../ui/PrimeReactReplacements';

// HVAC Hooks and Services - Direct imports to avoid circular dependencies
