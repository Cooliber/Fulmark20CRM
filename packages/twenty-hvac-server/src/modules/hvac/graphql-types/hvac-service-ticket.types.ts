...
export class CreateHvacServiceTicketInput {
  ...
  @Field(() => [ID], { nullable: 'itemsAndList' }) // Changed to array of IDs
  @IsOptional()
  @IsUUID('all', { each: true }) // Validate each item in the array as UUID
  equipmentIds?: string[]; // Changed to array of strings
