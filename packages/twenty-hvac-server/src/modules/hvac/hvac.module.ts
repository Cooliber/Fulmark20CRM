...
import { HvacExceptionFilter } from './filters/hvac-exception.filter';
import { HvacAudioTranscriptionResolver } from './resolvers/hvac-audio-transcription.resolver';
...
import { HvacAudioTranscriptionService } from './services/hvac-audio-transcription.service';
...
import { HvacEmailAttachmentProcessorService } from './services/hvac-email-attachment-processor.service';
import { HvacErrorHandlerService } from './services/hvac-error-handler.service';
import { HvacImapEmailMonitorService } from './services/hvac-imap-email-monitor.service';
...
@Module({
  ...
  providers: [
    ...
    HvacWeaviateService,
    HvacDataSyncService,
    HvacAudioTranscriptionService,
    HvacEmailAttachmentProcessorService,
    HvacImapEmailMonitorService,
    ...
    HvacAudioTranscriptionResolver,
    HvacPolishComplianceResolver,
  ],
  exports: [
    // Core Services
    HvacSentryService,
